    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
      ...
      <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
        ...
        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
               <div>
                   <h1 class="font-bold text-center mb-4">INSERT MOBIL</h1>
               </div>
               <div class="mb-2">
                        <input wire:model="mobilId" type="hidden" class="shaddow appearance-none border rounded w-full py-2 px-3 text-blue-500" placeholder="Mobil">
               </div>
               <div class="mb-2">
                        <label for="mobil" class="block">Mobil</label>
                        <input wire:model="mobil" type="text" class="shaddow appearance-none border rounded w-full py-2 px-3 text-blue-500" placeholder="Mobil">
                        @error('mobil') <h1 class="text-red-500">{{$message}}</h1> @enderror
               </div>
               <div class="mb-2">
